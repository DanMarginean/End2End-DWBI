...
random_dates = np.random.choice(np.arange(np.datetime64('2015-01-01'), np.datetime64('2025-07-28')), size=num_rows)
...
df.to_csv(f"..//ExcelData//factorders.csv", index=False)
