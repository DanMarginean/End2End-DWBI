...
excel_file_path_name = "C:/Users/digid/TWEB/DataIntegrationDWBI/.venv/CodeBase/ExcelData/LookupFile.xlsx"
...
with open(f"..//ExcelData//{csv_file}", mode='w', newline='') as file:
